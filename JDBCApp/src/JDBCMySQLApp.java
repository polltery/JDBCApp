...
and the main switchboard is set up and shown  
*/
						...
						implements ActionListener
{
	...
	final String urlstart = "jdbc:mysql://localhost/";
	String urluserpass;
	...
	void connectToDatabase()
	{
		...
		// dbname is set to the database you would like to connect to (comment by Balraj)
		String dbname = "finaleventdb";
